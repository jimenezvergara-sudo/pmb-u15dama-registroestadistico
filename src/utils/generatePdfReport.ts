...
export async function generatePdfReport(
  ...
  const renderBoxScoreChunk = (rows: BoxScoreRow[], startY: number) => {
    ...
    autoTable(doc, {
      ...
      alternateRowStyles: { fillColor: TABLE_ALT },
      columnStyles: {
        0:  { cellWidth: 32, fontStyle: 'bold', halign: 'left', overflow: 'linebreak' },
        1:  { cellWidth: 16.5, halign: 'center' },
        2:  { cellWidth: 16.5, halign: 'center' },
        3:  { cellWidth: 16.5, halign: 'center' },
        4:  { cellWidth: 16.5, halign: 'center' },
        5:  { cellWidth: 11,   halign: 'center', fontStyle: 'bold', fillColor: [245, 240, 255] },
        6:  { cellWidth: 7.5,  halign: 'center' },
        7:  { cellWidth: 7.5,  halign: 'center' },
        8:  { cellWidth: 7.5,  halign: 'center' },
        9:  { cellWidth: 7.5,  halign: 'center' },
        10: { cellWidth: 7.5,  halign: 'center' },
        11: { cellWidth: 7.5,  halign: 'center' },
        12: { cellWidth: 7.5,  halign: 'center' },
