  ...
  if (isLandscape) {
    return (
      <LiveGameLandscape
        ...
        setPendingShot={setPendingShot}
        setShowReport={setShowReport}
        setPendingQuarter={setPendingQuarter}
        setCourtRotation={setCourtRotation}
        handlePlayerSelect={handlePlayerSelect}
        handleQuickAction={handleQuickAction}
        handleResult={handleResult}
        handleUndo={handleUndo}
        handleTogglePause={handleTogglePause}
        recordOpponentScore={recordOpponentScore}
        undoLastOpponentScore={undoLastOpponentScore}
        recordSubstitution={recordSubstitution}
        snapshotCourtTime={snapshotCourtTime}
        endGame={endGame}
        deleteShot={deleteShot}
        deleteAction={deleteAction}
        deleteOpponentScore={deleteOpponentScore}
        toggleShotResult={toggleShotResult}
      />
    );
  }
